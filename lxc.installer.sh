...
function source_focal_4 {
    ...
    # CHECK OS CODENAME # --------------------------------------------------------------------------------------------------------------------------------- #
    [ "$(lsb_release -cs)" != "focal" ] && echo -e "[>] OS CODENAME IS NOT FOCAL" && exit 1
    # ----------------------------------------------------------------------------------------------------------------------------------------------------- #
...
function repo_xenial_3 {
    ...
    for package in $(echo "lxc-utils liblxc1 lxc") ; do
        ...
        version=$(apt policy $package 2> /dev/null | grep -v 'Installed\|Candidate' | grep 3.0 | head -n 1 | tr -s ' ' | cut -d ' ' -f 2)
        # ------------------------------------------------------------------------------------------------------------------------------------------------- #
